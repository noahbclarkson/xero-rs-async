//! API client for the UK Payroll API.
...
pub mod deductions;
pub mod earnings_orders;
pub mod earnings_rates;
pub mod employee_leave;
pub mod employee_leave_balances;
...
impl PayrollUkApi {
    ...
    #[must_use]
    pub fn earnings_orders(&self) -> earnings_orders::EarningsOrdersResource<'_> {
        earnings_orders::EarningsOrdersResource::new(self)
    }

    #[must_use]
    pub fn employee_leave(&self) -> employee_leave::EmployeeLeaveResource<'_> {
        employee_leave::EmployeeLeaveResource::new(self)
    }

    #[must_use]
    pub fn employee_leave_balances(
        &self,
    ) -> employee_leave_balances::EmployeeLeaveBalancesResource<'_> {
        employee_leave_balances::EmployeeLeaveBalancesResource::new(self)
    }
    ...
    #[must_use]
    pub fn employee_statutory_leave_balance(
        &self,
    ) -> employee_statutory_leave_balance::EmployeeStatutoryLeaveBalanceResource<'_> {
        employee_statutory_leave_balance::EmployeeStatutoryLeaveBalanceResource::new(self)
    }

    #[must_use]
    pub fn employee_statutory_leaves_summary(
        &self,
    ) -> employee_statutory_leaves_summary::EmployeeStatutoryLeavesSummaryResource<'_> {
        employee_statutory_leaves_summary::EmployeeStatutoryLeavesSummaryResource::new(self)
    }

    #[must_use]
    pub fn employee_statutory_sick_leave(
        &self,
    ) -> employee_statutory_sick_leave::EmployeeStatutorySickLeaveResource<'_> {
        employee_statutory_sick_leave::EmployeeStatutorySickLeaveResource::new(self)
    }
    ...
    #[must_use]
    pub fn employer_pensions(&self) -> employer_pensions::EmployerPensionsResource<'_> {
        employer_pensions::EmployerPensionsResource::new(self)
    }
